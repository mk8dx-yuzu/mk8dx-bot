...
class mogi(commands.Cog):
    ...
    @commands.group(name="testing", description="this is a test for so called command groups")
    ...
    @testing.command(name="add", description="Adds two numbers together.")
    ...
    @testing.command(name="subtract", description="Subtracts one number from another.")
