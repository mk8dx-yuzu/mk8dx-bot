...
class tags(commands.Cog):
    ...
    teams = SlashCommandGroup(name = "tags", description = "Edit Team tags and apply/remove respective roles")

    @teams.command(name="tag", description="set a tag for your own team")
    ...
    @teams.command(name = "set", description = "set a tag for any team by number", guild_only=True)
    async def set(
        self, 
    ...
    @teams.command(name = "apply_roles", description = "assign team roles", guild_only=True)
    ...
    @teams.command(name="unapply_roles", guild_only=True)
